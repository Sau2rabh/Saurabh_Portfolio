  ...
  return (
    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          <div className="absolute w-16 h-16 rounded-full bg-linear-to-br from-cyan-500 via-blue-500 to-teal-500 animate-pulse flex items-center justify-center z-10">
                  ...
                  <Card className="absolute top-20 left-1/2 -translate-x-1/2 w-64 bg-black/90 backdrop-blur-lg border-white/30 shadow-xl shadow-white/10 overflow-visible">
                    ...
                    <CardHeader className="pb-2">
                      <div className="flex justify-between items-center">
                        <Badge
                          className={`px-2 text-[10px] h-4 ${getStatusStyles(
                            item.status
                          )}`}
                        >
                    ...
                    <CardContent className="text-[11px] text-white/80">
                      <p>{item.content}</p>
